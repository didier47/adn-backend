    ...
    stages{
        stage('Checkout') {
            steps {
                ...
                gitCheckout(
                    urlProject:'git@github.com:didier47/adn-backend.git',
		...
		stage('Static Code Analysis') {
			steps{
				sonarqubeMasQualityGates(sonarKey:'co.com.ceiba.adn.core.bloque', 
				sonarName:'co.com.ceiba.adn.backend:backend', 
